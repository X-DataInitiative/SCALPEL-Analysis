...
from scalpel.core.util import rename_df_columns, index_string_column
...
class ConvSccsFeatureDriver(BaseFeatureDriver):
    ...
    followups: `Cohort`
        ...
        'start', 'stop', 'endReason'.
    exposures: `Cohort`
        Cohort containing the exposures information. This cohort should contain subjects
        and events matching the Event case class, that is the columns: 'patientID',
        'category', 'groupID', 'value', 'weight', 'start', 'end'.
    outcomes: `Cohort`
        Cohort containing the outcomes information. This cohort should contain subjects
        and events matching the Event case class, that is the columns: 'patientID',
        'category', 'groupID', 'value', 'weight', 'start', 'end'.
    ...
    bucket_size: `int`
        Size of the buckets used to disctretize time (expressed in number of days).
    ...
    age_groups: `list[int]`, default=None
        ...
        not computed. Beware: take into account the ageing of subjects when defining
        these. Minimum bound should be <= minimum age, maximum bound should be >=
        maximum age + study length.
    bucket_rounding: `string`, default='ceil'
        Depending on bucket_size and study start / end, the last bucket might be shorter
        the previous ones. If bucket_rounding is equal to 'ceil', then this bucket is
        kept as is. If bucket_rounding is equal to 'floor', then this bucket is removed
     ...
     run_checks: `bool`, default=True
        ...
        might increase performance, but use at your own risks!
     exposures_split_column: `str`, default='value'
        Events field used to identify the different types of exposures when computing
        the features.
     outcomes_split_column: `str`, default='value'
        Events field used to identify the different types of exposures when computing
        the outcomes.
    """
