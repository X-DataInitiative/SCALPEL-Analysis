...
def plot_drug_purchases_per_month_as_bars(figure: Figure, cohort: Cohort) -> Figure:
...
@register
@title("Drug Purchases per month")
def plot_drug_purchases_per_month_as_timeseries(figure: Figure, cohort: Cohort) -> Figure:
