...
class TestBaseLoader(PySparkTest):
    ...
    def test_find_inconsistent_start_end_ordering(self):
        ...
        invalid = BaseLoader._find_inconsistent_start_end_ordering(cohort)
    ...
    def test_properties_followups(self):
        ...
        with patch.object(
            BaseLoader, "_log_invalid_events_cohort", return_value="Ooops, error here!"
        ) as mock_log_invalid:
            with patch.object(
                BaseLoader,
